...
namespace FWO.Middleware.Server.Services
{
    ...
    public class ComplianceSchedulerService : IAsyncDisposable
    {
        ...
        public ComplianceSchedulerService(ISchedulerFactory schedulerFactory, ApiConnection apiConnection, GlobalConfig globalConfig, IHostApplicationLifetime appLifetime)
        {
