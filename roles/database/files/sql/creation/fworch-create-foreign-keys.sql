...
ALTER TABLE rule_owner ADD CONSTRAINT rule_owner_owner_source_stm_owner_foreign_key FOREIGN KEY (owner_source) REFERENCES stm_owner_source(owner_source_type_id) ON UPDATE RESTRICT ON DELETE CASCADE;
--- reqtask_owner ---
